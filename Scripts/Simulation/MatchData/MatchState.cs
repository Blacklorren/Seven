...
// Assuming GamePhase is defined here or appropriately referenced
// If GamePhase is in Core: using HandballManager.Core;
// If GamePhase is alongside SimBall etc: using HandballManager.Simulation.MatchData;
...
namespace HandballManager.Simulation.MatchData
{
    ...
    // Removed duplicate GamePhase enum - Assuming it's defined elsewhere (e.g., MatchSimulationData.cs)
}