...
using HandballManager.Core; // For Enums like PlayerPosition, InjuryStatus
    ...
    public class PlayerData
    {
        ...
        public PlayerData()
        {
            ...
            // Set a default date of birth if not specified
             ...
             GeneratePersonality(); // Generate personality trait
        }
        ...
        public int CalculateCurrentAbility()
        {
            ...
            AddStat(Composure); AddStat(Concentration); AddStat(Anticipation); AddStat(DecisionMaking); AddStat(Teamwork); AddStat(WorkRate);
        ...
        public bool IsInjured()
        {
             ...
             if (CurrentInjuryStatus != InjuryStatus.Healthy)
             {
                 try {
                     ...
                     // Handle case where GameManager or TimeManager might not be ready
         ...
         public void InflictInjury(InjuryStatus status, int durationDays, string description)
         {
             ...
             try {
                InjuryReturnDate = Core.GameManager.Instance.TimeManager.CurrentDate.AddDays(durationDays);
                 ...
                 InjuryReturnDate = DateTime.Now.AddDays(durationDays); // Fallback if game time unavailable
             }
